...
const GroundFloor: React.FC = () => {
  ...
  useEffect(() => {
    const loadArea = async () => {
      const savedArea = await storage.getItem('areaGroundFloor');
      if (savedArea) {
        setAreaGroundFloor(savedArea);
      }
    };
    loadArea();
  }, []);
  ...
  useEffect(() => {
    const saveArea = async () => {
      await storage.setItem('areaGroundFloor', areaGroundFloor);
    };
    saveArea();
  }, [areaGroundFloor]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bodyContainer}>
        <InputField
          name=""
          value={areaGroundFloor}
          onChangeText={setAreaGroundFloor}
