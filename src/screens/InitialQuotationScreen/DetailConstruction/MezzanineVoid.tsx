...
const MezzanineVoid: React.FC = () => {
  ...
  const route =
    useRoute<RouteProp<ConstructionStackParamList, 'MezzanineVoid'>>();
  const {Name} = route.params;

  const [areaMezzanineVoid, setAreaMezzanineVoid] = useState('');
  ...
  const totalPriceMezzanineVoid = constructionArea * unitPrice || 0;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bodyContainer}>
        <InputField
          name=""
          value={areaMezzanineVoid}
          onChangeText={setAreaMezzanineVoid}
        ...
        <View>
          ...
          <View style={styles.titleGroup}>
            ...
            <Text style={styles.total}>
              {totalPriceMezzanineVoid.toLocaleString()} VNĐ
            </Text>
          </View>
        </View>
      </View>
