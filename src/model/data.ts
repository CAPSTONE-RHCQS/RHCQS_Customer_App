...
export const profileData = [
  {
    name: 'Nguyễn Nghị',
    image: require('../assets/image/data/avatar.jpeg'),
  }
]
...
export const chatListData = [
  {
    Id: '1',
    AvatarStaff: require('../assets/image/data/avatar.jpeg'),
    StaffName: 'Nguyễn Nghị',
    MessageContext: 'ádfasdfasdfasdfasdfasdfasdfasdfa',
    SendAt: '12/12/2024',
    isRead: false,
  },
  {
